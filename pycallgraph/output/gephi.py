# TODO: All tests for Gephi implementation are commented out. Should Gephi be supported?
import math
...
class GephiOutput(Output):
    ...
    def add_arguments(cls, subparsers, parent_parser, usage):
        ...
        subparser = subparsers.add_parser(
            "gephi",
            help="Gephi GDF generation",
            parents=[parent_parser],
            usage=usage,
        )

        cls.add_output_file(subparser, defaults, "The generated Gephi GDF file")
